...
<html lang="en">
    ...
    <body>
       <section class="header" style="background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(images/snacks_banner.png);">
            <div class="navbar">
           ...
           <h4 style="text-align:center;">Search Category: <b><u>Snacks</u></b></h4>
           <?php
                if($insert == true){
