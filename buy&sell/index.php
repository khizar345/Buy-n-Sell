       ...
       <section class="header">
           ...
           <form action="search.php" method="POST">
            <div class="input-group"><!--bootstrap class-->
                <input type="text" name="ValueToSearch" class="form-control" placeholder="Search for a product..."> 
                <!--input box-->
                    ...
                    <div class="col-md-4"><!--bootstrap columns-->
                        <div class="offer-box">
                            ...
                            <div class="offer-details">
                                ...
                                <a href="breakfast.php" style="color:white"><div>
                    ...
                    <div class="col-md-4">
                        <div class="offer-box">
                            ...
                            <div class="offer-details">
                                ...
                                <a href="cleaning.php" style="color:white"><div>
                    ...
                    <div class="col-md-4">
                        <div class="offer-box">
                            ...
                            <div class="offer-details">
                                ...
                                <a href="snacks.php" style="color:white"><div>
                                    <i class="fa"><strong>Shop Now!</strong></i>
                                </div></a>
                            </div>
                        </div>
